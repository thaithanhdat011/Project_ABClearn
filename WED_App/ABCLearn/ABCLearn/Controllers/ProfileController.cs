...
namespace ABCLearn.Controllers
{
    public class ProfileController : Controller
    {
        ...
        public IActionResult UploadAvatar(IFormFile image)
        {
            ...
            renderData(); // lấy tất cả dữ liệu để hiển thi trên dao diện người dùng
            SessionUser(); 
            //được sử dụng để lưu trữ thông tin người dùng vào session và cung cấp các dữ liệu cần thiết để hiển thị trên giao diện người dùng.
